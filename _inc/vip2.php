...
<div class="box_middle">Abaixo temos uma tabela com os valores para doação. Escolha uma das opções de valores abaixo, e siga os procedimentos do PagSeguro ou PayPal. Lembre-se que, sendo uma doação, o jogador não terá o direito de pedir o valor de volta, pois o mesmo será utilizado em investimentos para o <?php echo nome_servidor(); ?>. Como agradecimento pela doação, lhe será concedido uma conta VIP.<div class="sep"></div>
	...
	<table width="100%" cellpading="0" cellspacing="1">
        <tr class="table_dados" style="background:#323232;text-align:left;">
        	<td>Conta VIP <?php echo nome_servidor(); ?> -  45 dias</td>
            <td>R$ 6,00</td>
        </tr>
    </table>
  	 ...
  	 <tr class="table_dados" style="background:#323232;">
  		<td>Desejo utilizar o PagSeguro para doar<br />
        	<!-- INICIO FORMULARIO BOTAO PAGSEGURO -->
             ...
             <input type="hidden" name="email_cobranca" value="vip@anubisserve.net">
             <input type="hidden" name="tipo" value="CP">
             <input type="hidden" name="moeda" value="BRL">
             <input type="hidden" name="item_id_1" value="NH30">
             <input type="hidden" name="item_descr_1" value="Conta VIP <?php echo nome_servidor(); ?> - 45 dias (ID <?php echo 50000+$db['id']; ?>)">
      	...
      	<td width="50%">Desejo utilizar o PayPal para doar<br />
            ...
            <input type="hidden" name="item_name" value="Conta VIP AnubisServe - 30 dias (ID <?php echo 50000+$db['id']; ?>)">
            ...
            <input type="hidden" name="cmd" value="_s-xclick">
            <input type="hidden" name="item_name" value="Conta VIP <?php echo nome_servidor(); ?> - 45 dias (ID <?php echo 50000+$db['id']; ?>)">
