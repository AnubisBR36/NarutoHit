<?php
$stmt = $conexao->prepare("SELECT i.id,i.valor as anunciado,i.upgrade,t.categoria,t.descricao,t.taijutsu,t.ninjutsu,t.genjutsu,t.nome,t.imagem,t.valor FROM inventario i LEFT OUTER JOIN table_itens t ON i.itemid=t.id WHERE i.usuarioid=? AND venda='sim' ORDER BY i.id ASC");
$stmt->execute([$db['id']]);
...
<div class="box_middle">Alguns itens sendo vendidos na loja de <?php echo $db['usuario']; ?>.<div class="sep"></div>
	<table width="100%" cellspacing="1" cellpadding="0">
        ...
        <tr class="table_dados" style="background:#323232;" onmouseover="style.background='#2C2C2C'" onmouseout="style.background='#323232'">
            <td align="center" width="140" valign="top"><img src="_img/equipamentos/<?php echo $dbs['imagem']; ?>.png" /></td>
        ...
        <?php } while($dbs = $stmt->fetch(PDO::FETCH_ASSOC)); ?>
    </table>
