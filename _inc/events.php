...
<div class="box_middle">A cada dia da semana ocorrerá um evento diferente. Abaixo estão todos os eventos programados pela <?php echo nome_servidor(); ?>, o dia da semana em que o evento acontecerá, e a descrição de cada um.<div class="sep"></div>
