					...
					<div id="lz_chat_login_details">
						<table cellpadding="5" cellspacing="3">
							<tr>
								...
								<td width="220"><input id="lz_chat_login_name" name="login_name" class="lz_chat_login_box"  value="<!--login_value_name-->" maxlength="32" disabled="disabled" onKeyDown="if(event.keyCode==13){return document.getElementById('login_email').focus();}"></td>
							</tr>
							<tr>
								<td class="lz_chat_form_field"><strong><!--lang_client_your_email-->:</strong></td>
								<td><input id="lz_chat_login_email" name="login_email" class="lz_chat_login_box" value="<!--login_value_email-->" maxlength="50" disabled="disabled" onKeyDown="if(event.keyCode==13){return document.getElementById('login_company').focus();}"></td>
							</tr>
							<tr>
