...
<div class="city_div">Parabéns! Você alcançou o nível <b><?php echo (int)$_GET['lvl']; ?></b>.<br />Continue a ganhar experiência para subir mais e mais no ranking!<br />Como recompensa, nós lhe daremos <b>300,00 yens</b>.<?php if($_GET['lvl']>=14){ echo '<br />Como bônus, você recebeu '.((int)$_GET['lvl']*9).' pontos de experiência por estar acima do nível 14.'; } ?>
</div>
